...
//------------------------------------------------ Plot setup data Even-----------------------------------------			
var ui_chartPsDataSetEven={
  id:"graphPsDataSetEven",
  view:"chart",
  type:"line",
  xValue:"#t#",
...
//------------------------------------------------ Plot setup data Odd-----------------------------------------			
var ui_chartPsDataSetOdd={
  id:"graphPsDataSetOdd",
  view:"chart",
  type:"line",
  xValue:"#t#",
  xAxis:{lines:function(obj){return obj.t%100?false:true}, template:function(obj){return obj.t%100?"":obj.t},title:"t, ms"},
...
//------------------------------------------------ View Plot setup Even data ------------------------------------
var ui_graphViewPsSetupDataEven = {
  id:"graphViewPsSetupDataEven",
  view:"layout",
  container:"formContainer",
  rows:[{cols:[ui_chartPsDataSetEven]}]
}
//------------------------------------------------ View Plot setup Odd data ------------------------------------
var ui_graphViewPsSetupDataOdd = {
  id:"graphViewPsSetupDataOdd",
  view:"layout",
  container:"formContainer",
  rows:[{cols:[ui_chartPsDataSetOdd]}]
}
...
var ui_tabview = {
    ...
    cells:[ 
      ...
      {
        header: localizator.lex_t2_e,//"Vobler PS setup current in even cycle",
        body:{
           id:"t2_e",rows:[ui_graphViewPsSetupDataEven ]   
        }      
      },
      {
        header: localizator.lex_t2_o,//"Vobler PS setup current in odd cycle",
        body:{
           id:"t2_o",rows:[ui_graphViewPsSetupDataOdd]   
        }      
      },
      { 
