...
// get curren measure
        ...
        orb->readMeasure(mTime_cur,tresholdI_cur,oR_cur,oZ_cur);
...
// processing ststus or error request
    if(haveErrStatusMsg){
      haveErrStatusMsg=false;
...
// write status
  ...
  if(cur_par.mode==2) direction="view R/Z direction";
  else if(cur_par.dir==0) direction="view R direction";
  else if(cur_par.dir==1) direction="view Z direction";
  ...
  if(cur_par.launch&0x1) B2KC1="KC1"; else B2KC1="B2";
  QString kv="\"",cm=",";
